...
export default function Page() {
  ...
  function savePolicy() {
    ...
    setPolicies((current) => [{ id: crypto.randomUUID(), number: form.number, cedant: form.cedant, occupancy: form.occupancy, premium: Number(form.premium) || 0, sumInsured: Number(form.sumInsured) || 0, market: marketFor(form.occupancy, Number(form.sumInsured) || 0), expiry: form.expiry || '30 Jun 2027', premiumStatus: 'Outstanding', status: 'Active' }, ...current])
